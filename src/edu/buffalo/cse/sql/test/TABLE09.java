...
public class TABLE09 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new TABLE09());
  }
  public void testRA() {
    ...
    SelectionNode child_1 = new SelectionNode(new ExprTree(ExprTree.OpCode.AND, new ExprTree(ExprTree.OpCode.EQ, new ExprTree.VarLeaf("R", "B"), new ExprTree.VarLeaf("S", "B")), new ExprTree(ExprTree.OpCode.LT, new ExprTree.VarLeaf("T", "C"), new ExprTree.VarLeaf("S", "C"))));
