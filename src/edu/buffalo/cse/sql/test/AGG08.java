...
public class AGG08 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new AGG08());
  }
  public void testRA() {
    ...
    System.out.println("Passed RA Test AGG08");
  }
  public void testSQL() {
    List<List<Datum[]>> expected = new ArrayList<List<Datum[]>>();
    expected.add(getResults0());
    TestHarness.testProgram(new File("test/AGG08.SQL"),
                            expected);
    System.out.println("Passed SQL Test AGG08");
  }
  ArrayList<Datum[]> getResults0() {
    ArrayList<Datum[]> ret = new ArrayList<Datum[]>();
    ret.add(new Datum[] {new Datum.Int(59)}); 
    return ret;
  }
}
