...
public class CONST12 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new CONST12());
  }
  public void testRA() {
    ...
    query_0.addColumn(new ProjectionNode.Column("joe", new ExprTree.ConstLeaf(-1.2E-4)));
    query_0.setChild(child_1);
    TestHarness.testQuery(tables, getResults0(), query_0);
    System.out.println("Passed RA Test CONST12");
  }
  public void testSQL() {
    List<List<Datum[]>> expected = new ArrayList<List<Datum[]>>();
    expected.add(getResults0());
    TestHarness.testProgram(new File("test/CONST12.SQL"),
                            expected);
    System.out.println("Passed SQL Test CONST12");
  }
