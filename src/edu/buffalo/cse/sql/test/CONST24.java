...
public class CONST24 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new CONST24());
  }
  public void testRA() {
  ...
  public void testSQL() {
    ...
    TestHarness.testProgram(new File("test/CONST24.SQL"),
                            expected);
    System.out.println("Passed SQL Test CONST24");
  }
