...
public class AGG10 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new AGG10());
  }
  public void testRA() {
    ...
    query_0.addAggregate(new AggregateNode.AggColumn("Sum", new ExprTree(ExprTree.OpCode.ADD, new ExprTree.VarLeaf(null, "A"), new ExprTree.VarLeaf(null, "B")),AggregateNode.AType.SUM));
    query_0.addAggregate(new AggregateNode.AggColumn("Average", new ExprTree(ExprTree.OpCode.ADD, new ExprTree.VarLeaf(null, "C"), new ExprTree.VarLeaf(null, "B")),AggregateNode.AType.AVG));
