...
public class TABLE05 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new TABLE05());
  }
  public void testRA() {
    ...
    System.out.println("Passed RA Test TABLE05");
  }
  public void testSQL() {
    List<List<Datum[]>> expected = new ArrayList<List<Datum[]>>();
    expected.add(getResults0());
    TestHarness.testProgram(new File("test/TABLE05.SQL"),
                            expected);
    System.out.println("Passed SQL Test TABLE05");
  }
