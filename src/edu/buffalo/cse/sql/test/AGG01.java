...
public class AGG01 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new AGG01());
  }
  public void testRA() {
    ...
    System.out.println("Passed RA Test AGG01");
  }
  public void testSQL() {
    List<List<Datum[]>> expected = new ArrayList<List<Datum[]>>();
    expected.add(getResults0());
    TestHarness.testProgram(new File("test/AGG01.SQL"),
                            expected);
    System.out.println("Passed SQL Test AGG01");
  }
