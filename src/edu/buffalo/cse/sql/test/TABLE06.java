...
public class TABLE06 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new TABLE06());
  }
  public void testRA() {
    ...
    SelectionNode child_1 = new SelectionNode(new ExprTree(ExprTree.OpCode.AND, new ExprTree(ExprTree.OpCode.EQ, new ExprTree.VarLeaf("R", "B"), new ExprTree.VarLeaf("S", "B")), new ExprTree(ExprTree.OpCode.OR, new ExprTree(ExprTree.OpCode.GT, new ExprTree.VarLeaf("R", "A"), new ExprTree.VarLeaf("S", "C")), new ExprTree(ExprTree.OpCode.LT, new ExprTree.VarLeaf("R", "A"), new ExprTree.VarLeaf("S", "C")))));
    ...
    System.out.println("Passed RA Test TABLE06");
  }
  public void testSQL() {
    List<List<Datum[]>> expected = new ArrayList<List<Datum[]>>();
    expected.add(getResults0());
    TestHarness.testProgram(new File("test/TABLE06.SQL"),
                            expected);
    System.out.println("Passed SQL Test TABLE06");
  }
