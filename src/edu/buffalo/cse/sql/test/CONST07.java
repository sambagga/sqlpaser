...
public class CONST07 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new CONST07());
  }
  public void testRA() {
    ...
    System.out.println("Passed RA Test CONST07");
  }
  public void testSQL() {
    List<List<Datum[]>> expected = new ArrayList<List<Datum[]>>();
    expected.add(getResults0());
    TestHarness.testProgram(new File("test/CONST07.SQL"),
                            expected);
    System.out.println("Passed SQL Test CONST07");
  }
