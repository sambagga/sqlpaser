...
public class TABLE08 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new TABLE08());
  }
  public void testRA() {
    ...
    System.out.println("Passed RA Test TABLE08");
  }
  public void testSQL() {
    List<List<Datum[]>> expected = new ArrayList<List<Datum[]>>();
    expected.add(getResults0());
    TestHarness.testProgram(new File("test/TABLE08.SQL"),
                            expected);
    System.out.println("Passed SQL Test TABLE08");
  }
