...
public class AGG09 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new AGG09());
  }
  public void testRA() {
    ...
    System.out.println("Passed RA Test AGG09");
  }
  public void testSQL() {
    List<List<Datum[]>> expected = new ArrayList<List<Datum[]>>();
    expected.add(getResults0());
    TestHarness.testProgram(new File("test/AGG09.SQL"),
                            expected);
    System.out.println("Passed SQL Test AGG09");
  }
  ArrayList<Datum[]> getResults0() {
    ArrayList<Datum[]> ret = new ArrayList<Datum[]>();
    ret.add(new Datum[] {new Datum.Int(59), new Datum.Flt(2.5789473)}); 
    return ret;
  }
}
