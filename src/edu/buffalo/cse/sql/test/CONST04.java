...
public class CONST04 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new CONST04());
  }
  public void testRA() {
    ...
    System.out.println("Passed RA Test CONST04");
  }
  public void testSQL() {
    List<List<Datum[]>> expected = new ArrayList<List<Datum[]>>();
    expected.add(getResults0());
    TestHarness.testProgram(new File("test/CONST04.SQL"),
                            expected);
    System.out.println("Passed SQL Test CONST04");
  }
