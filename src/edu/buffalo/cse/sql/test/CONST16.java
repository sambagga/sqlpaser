...
public class CONST16 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new CONST16());
  }
  public void testRA() {
    ...
    System.out.println("Passed RA Test CONST16");
  }
  public void testSQL() {
    List<List<Datum[]>> expected = new ArrayList<List<Datum[]>>();
    expected.add(getResults0());
    TestHarness.testProgram(new File("test/CONST16.SQL"),
                            expected);
    System.out.println("Passed SQL Test CONST16");
  }
