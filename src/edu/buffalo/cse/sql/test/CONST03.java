...
public class CONST03 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new CONST03());
  }
  public void testRA() {
    ...
    System.out.println("Passed RA Test CONST03");
  }
  public void testSQL() {
    List<List<Datum[]>> expected = new ArrayList<List<Datum[]>>();
    expected.add(getResults0());
    TestHarness.testProgram(new File("test/CONST03.SQL"),
                            expected);
    System.out.println("Passed SQL Test CONST03");
  }
